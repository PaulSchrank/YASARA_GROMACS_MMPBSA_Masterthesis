...
AddSpring C16 Res CBZ 1 Mol A, SG Res CYM 69 Mol A,Len=2.5, SFC=50
AddSpring N16 Res CBZ 1 Mol A, OD2 Res 260 Mol A, Len=2.5, SFC=50
AddSpring Backbone Mol A, CurrentPos, Len=0,SFC=10

# Uncomment to modify charges, e.g. let Trp 12 in Mol A lose an electron:
ChargeRes Cys 69 Mol A, 0
